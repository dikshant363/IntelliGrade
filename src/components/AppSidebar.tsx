import { Home, Users, ClipboardList, FileText, LogOut, GraduationCap, Settings, Cpu } from "lucide-react";
...
export function AppSidebar() {
  ...
  const adminItems = [
    ...
    { title: "System Utilities", url: "/admin/system-utilities", icon: Cpu },
  ];
